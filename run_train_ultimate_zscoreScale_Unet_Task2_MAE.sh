...
#SBATCH --job-name=Task2_2_3000_timestep__patchsize_2_Unet_MAE_linear_DA_0.5_pen_var_random_T_1000_1600
#SBATCH --output=sbatch_out_final/Task2_2_3000_timestep__patchsize_2_Unet_MAE_linear_DA_0.5_pen_var_random_T_1000_1600_%J.txt
#SBATCH --gpus=1
#SBATCH --nodes=1
#SBATCH --mem=100G
#SBATCH --ntasks=1
...
python train_mc_IDDPM.py \
    ...
    --resume /projects/nian/synthrad2025/results/MC-IDDPM/VS-DDPM_Task2_2_3000_timestep__patchsize_2_Unet_MAE_128_128_32_ScaleIntensityRanged_region_HN_TH_AB_linear_DA_0.5_pen_var_random_T_CTminmax-1000_1600/wandb/run-20260105_114414-zya1k0x6/files/model/A_to_B_model_899.pt
